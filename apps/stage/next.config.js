...
module.exports = withPlugins([withTranspileModules], {
	...
	publicRuntimeConfig: {
		...
		// Sample
		NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_API: process.env.NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_API,
		NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_INDEX: process.env.NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_INDEX,
		NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_MANIFEST_COLUMNS: process.env.NEXT_PUBLIC_ARRANGER_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_MAX_BUCKET_COUNTS:
			process.env.NEXT_PUBLIC_ARRANGER_SAMPLE_DATA_MAX_BUCKET_COUNTS || 1000,
		NEXT_PUBLIC_ENABLE_SAMPLE_QUICKSEARCH: process.env.NEXT_PUBLIC_ENABLE_SAMPLE_QUICKSEARCH,

		// Summary
		NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_API: process.env.NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_API,
		NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_INDEX: process.env.NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_INDEX,
		NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_MANIFEST_COLUMNS:
			process.env.NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_MAX_BUCKET_COUNTS:
			process.env.NEXT_PUBLIC_ARRANGER_SUMMARY_DATA_MAX_BUCKET_COUNTS || 1000,
		NEXT_PUBLIC_ENABLE_SUMMARY_QUICKSEARCH: process.env.NEXT_PUBLIC_ENABLE_SUMMARY_QUICKSEARCH,

		// Id
		NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_API: process.env.NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_API,
		NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_INDEX: process.env.NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_INDEX,
		NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_MANIFEST_COLUMNS:
			process.env.NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_MAX_BUCKET_COUNTS:
			process.env.NEXT_PUBLIC_ARRANGER_ID_MAPPING_DATA_MAX_BUCKET_COUNTS || 1000,
		NEXT_PUBLIC_ENABLE_ID_MAPPING_QUICKSEARCH: process.env.NEXT_PUBLIC_ENABLE_ID_MAPPING_QUICKSEARCH,
